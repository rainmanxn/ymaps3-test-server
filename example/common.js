ymaps3.import.loaders.unshift(async (pkg) => {
    ...
    await ymaps3.import.script(`https://unpkg.com/@yandex/ymaps3-entity-tile-loader/dist/index.js`);
...
const TILE_SIZE = 256;
// const TEST_TILE_SERVER = 'https://api-test.maps-creator.com';
...
//     const entity = new ymaps3.YMapFeature({
